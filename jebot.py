...
Jebot = Client(
   "Song Downloader",
   api_id=3678414,
   api_hash="7093f9c89addce5894492a30f73be34d",
   bot_token="1953870935:AAF3yYLfO52PlnvXcDF2IaBDUNsQBIRnMhY",
)
...
async def song(client, message):
    ...
    time.time()
    if song:
        await rkp.edit("Uploading by SongFinder...") #ImJanindu
        lol = "./thumb.jpg"
...
async def start(client, message):
   if message.chat.type == 'private':
       await Jebot.send_message(
               ...
               text="""<b>Hey There, I'm a Song Downloader Bot. A bot by @TharushaT.
